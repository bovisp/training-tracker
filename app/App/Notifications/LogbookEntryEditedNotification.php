...
class LogbookEntryEditedNotification extends Notification
{
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'editorId' => $this->logbookEntry->editor->id,
            'editorName' => "{$this->logbookEntry->editor->moodleuser->firstname} {$this->logbookEntry->editor->moodleuser->lastname}",
