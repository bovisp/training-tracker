...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fecha__ = __webpack_require__(39);
...
window.fecha = __WEBPACK_IMPORTED_MODULE_2_fecha___default.a;
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('datatable', __webpack_require__(48));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('user-errors', __webpack_require__(52));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('appointment-date', __webpack_require__(55));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('flash', __webpack_require__(58));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('unassigned-user-lessons', __webpack_require__(61));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_userlesson__ = __webpack_require__(44);
...
function updateCompletedObjectives(state, payload) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48d06efd", Component.options)
  } else {
    hotAPI.reload("data-v-48d06efd", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getRecords: function getRecords() {
            ...
            return axios.get('' + this.endpoint).then(function (_ref) {
                var data = _ref.data;
                ...
                if (data.data.checked) {
                    data.data.checked.forEach(function (key) {
                        return _this2.recordsModel[key] = true;
                    });
                }
            });
        },
        ...
        validateWithRoles: function validateWithRoles() {
            var records = this.validateSelectedRecords();
        ...
        actionButtonLink: function actionButtonLink(id) {
    ...
    _c("table", { staticClass: "table is-fullwidth is-sortable" }, [
      _c("thead", [
        _c(
          "tr",
          [
            _vm.hasCheckbox ? _c("th", [_vm._v(" ")]) : _vm._e(),
            _vm._v(" "),
                ...
                _c(
                  ...
                  [
                    _c("span", [
                      _vm._v(
                        "\n                            " +
                          _vm._s(_vm.getTranslatedColumnName(column)) +
                          "\n                        "
                      )
                    ]),
                    _vm._v(" "),
            ...
            _vm._v(" "),
            _vm.actionButton ? _c("th", [_vm._v(" ")]) : _vm._e(),
            _vm._v(" "),
                ...
                ? _c("td", [
                    _c(
                      "a",
                      {
                        ...
                        attrs: { href: _vm.actionButtonLink(record.id) }
                      },
                      [
                        _vm._v(
                          "\n                        " +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48d06efd", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\AppointmentDate.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-39250f46", Component.options)
  } else {
    hotAPI.reload("data-v-39250f46", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	data: function data() {
		return {
			appointmentDate: '',
			editing: false,
			errors: new __WEBPACK_IMPORTED_MODULE_0__classes_Error__["a" /* default */]()
		};
	},


	computed: {
		appointedAt: function appointedAt() {
	...
	methods: {
		update: function update() {
			...
			axios.put('/users/api/' + this.user.id + '/appointment', {
				...
				_this.errors.clear('appointed_at');

				_this.appointmentDate = new Date(data.date);
			}).catch(function (error) {
				if (error.status === 422) {
					_this.errors.record(error.data.errors);
				}
			});
		}
	},
...
Component.options.__file = "resources\\assets\\js\\components\\userlessons\\UserLesson.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4491f634", Component.options)
  } else {
    hotAPI.reload("data-v-4491f634", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapState */])({
		status: function status(state) {
			return state.userlesson.status;
		},
	...
	methods: _extends({
		submit: function submit() {
			...
			this.$store.dispatch('userlessons/updateLessonPackage').then(function (_ref) {
				...
				_this.fetch({
					userlesson: _this.userLesson.id,
					user: _this.user.id
				});
			}).catch(function (error) {
				if (error.status === 422) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4491f634", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\userlessons\\UserLessonStatus.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ef6c1510", Component.options)
  } else {
    hotAPI.reload("data-v-ef6c1510", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h3", { staticClass: "title is-3 mt-6" }, [_vm._v("\n\t\tStatus\n\t")]),
    _vm._v(" "),
    _c("div", { staticClass: "columns is-desktop" }, [
      _c(
        ...
        [
          _c("div", { staticClass: "field" }, [
            _c("label", { staticClass: "label", attrs: { for: "p9" } }, [
              _vm._v("Early EG-03")
            ]),
            _vm._v(" "),
            _c(
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "field" }, [
            _c("label", { staticClass: "label", attrs: { for: "p18" } }, [
              _vm._v("Late EG-03")
            ]),
            _vm._v(" "),
            _c(
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "field" }, [
            _c("label", { staticClass: "label", attrs: { for: "p30" } }, [
              _vm._v("Early EG-04")
            ]),
            _vm._v(" "),
            _c(
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "field" }, [
            _c("label", { staticClass: "label", attrs: { for: "p42" } }, [
              _vm._v("late EG-04")
            ]),
            _vm._v(" "),
            _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ef6c1510", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\userlessons\\UserLessonObjectives.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b9b78e0", Component.options)
  } else {
    hotAPI.reload("data-v-3b9b78e0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		...
		window.events.$on('objective-errors', function (errors) {
			_this.errors.record(errors);
		});
	}
});
  ...
  return _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.objectives, function(objective) {
        return _c("li", { key: objective.id, staticClass: "mb-4" }, [
          _c("label", { staticClass: "checkbox" }, [
            _c("input", {
              ...
              domProps: {
                ...
                checked: Array.isArray(_vm.completed)
                  ? _vm._i(_vm.completed, objective.id) > -1
                  : _vm.completed
              },
              on: {
                change: function($event) {
            ...
            _vm._v(" "),
            _c("strong", [_vm._v(_vm._s(objective.number) + " - ")]),
    ...
    _vm._v(" "),
    _vm.errors.has("objectives")
      ? _c("article", { staticClass: "message is-danger mt-4" }, [
          _c("div", { staticClass: "message-body content" }, [
            _c("ul", { staticClass: "mt-0" }, [
              _c("li", {
                domProps: { textContent: _vm._s(_vm.errors.get("objectives")) }
              })
            ])
          ])
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3b9b78e0", module.exports)
  }
}
